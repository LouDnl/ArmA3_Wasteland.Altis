	...
	_inrange_payout = false;
		{
			...
			{
				if ((player distance (getmarkerpos _x))< 1000) then
				{
		...
		{ 
		titleText ["You are more than 1000 meters away from the capture territories so you received no money.", "plain down", 0.5];
		};
